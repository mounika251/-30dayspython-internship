...
# i) dd an item in to the list(using funtion)
...
# iii) store the largest number from the list to a variable

a=[1,2,3,10,7,8,20]
l=max(a)
print(l)

# iv) store the smallest number from the list to a variable
